...
function RTS() {
  ...
  return (
    ...
    CardText tag = "h6" >
    Age of Empires IV is an upcoming real - time strategy video game developed by Relic Entertainment and published by Xbox Game Studios.It is the fourth installment of the Age of Empires series.The game is scheduled
    for release in late 2021. Game events are set to be in the Middle Ages.Amongst others there will be a campaign telling a story about Norman Conquest of England.

    <
    /CardText> <
    CardText tag = "h6" >
    On August 21, 2017, Microsoft announced Age of Empires IV, developed by Relic Entertainment.Microsoft 's Executive Vice-President of Gaming, Phil Spencer, confirmed on June 11, 2019, that Age of Empires IV is still in development, with more information coming later in 2019.
    On November 14, 2019, gameplay footage of Age of Empires IV was shown at the X019 event.It showed medieval warfare between English and Mongol forces.On March 16, 2021, the fan preview was released, showing more detailed gameplay and also including the two other known civilisations, the Chinese and the Delhi Sultanate.The game will be released in Fall of 2021, although the specific date is not known. <
    /CardText> <
    /CardBody> <
    ...
    for Microsoft Windows.The game spawned the StarCraft franchise, and became the first game of the video game series.A Classic Mac OS version was released in 1999, and a Nintendo 64 adaptation, co - developed with Mass Media, was released in 2000. <
    CardText tag = "h6" >
    ...
    /CardText> <
    CardText tag = "h6" >
    Rise of Nations: Extended Edition is a re - release of the main game and its expansion.It released
    for Steam on June 12, 2014 and
    for the Windows 10 Store on September 14, 2017 with Xbox Live achievements and cross - play with the Steam version.Graphical changes to the game include updated textures, lighting and water.Other changes to the game include Steamworks integration which adds cloud saves, Steam Trading Cards, achievements, Twitch integration and multiplayer with Elo ranked matches to the game.Extended Edition is developed by SkyBox Labs. <
    /CardText> <
    /CardBody> <
    ReactAudioPlayer src = {
      rOfN
    ...
    /CardText> <
    CardText tag = "h6" >
    Age of Mythology was commercially successful, going platinum four months after its release after selling over one million units.In 2003, it was followed by an expansion pack, Age of Mythology: The Titans.On May 8, 2014, Age of Mythology: Extended Edition was released
    for Windows via Steam.This was followed by a second expansion pack, Age of Mythology: Tale of the Dragon, released on January 28, 2016. <
    /CardText> <
    /CardBody> <
    ReactAudioPlayer src = {
      ageOfM
