...
function Cards() {
  ...
  return ( <
    ...
    h4 className="descp"> The game lists where you can find the best games are now with you.Choose the type of game you are interested in and learn about games.You can read the descriptions of the games, view their pictures and listen to their music.FPS, RTS, TPS, MOBA, Open World and Battle Royale games are now available!
    <
    /h4> < /
    div > <
    CardGroup >
    ...
    with the player experiencing the action through the eyes of the protagonist and controlling the player character in a three - dimensional space.The genre shares common traits with other shooter games, and in turn falls under the action game genre. <
    /CardText> < /
    CardBody > <
    /Card> <
    Card >
    ...
    CardText tag = "h6" >
    TPS is a subgenre of 3 D shooter games in which the gameplay consists primarily of shooting. <
    /CardText> < /
    CardBody > <
    /Card> < /
    CardGroup > <
